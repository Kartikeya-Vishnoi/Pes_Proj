...
import {doc,getDoc,setDoc,updateDoc,query,collection,onSnapshot} from "firebase/firestore";
...
function Student(){
  ...
  useEffect(() => {
    ...
    return(
        ...
        {bl===1 ? <button className={classes.button} onClick={chathandler}>Join ChatRoom</button> :
          ""
    }
